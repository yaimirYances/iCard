import { BASE_API, ORDER_STATUS } from "../util/constants";

export async function getOrderTableApi(id, status = "", ordering = "") {
  try {
...
export async function addUOrderToTableApi(idTable, idProduct) {
  try {
...
export async function getOrderByPaymentApi(idPayment) {
  try {
